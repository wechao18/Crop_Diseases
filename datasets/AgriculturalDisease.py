...
_FILE_PATTERN = 'AgriculturalDisease_%s_*.tfrecord'

SPLITS_TO_SIZES = {'train': 31718, 'validation': 4540}
SPLITS_TO_SIZES_TEST = {'test': 4514} #4514

_NUM_CLASSES = 61

_ITEMS_TO_DESCRIPTIONS = {
    'image': 'A color image of varying size.',
    'label': 'A single integer between 0 and 60',
}
