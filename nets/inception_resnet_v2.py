    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      if create_aux_logits and num_classes:
        with tf.variable_scope('AuxLogits'):
          ...
          aux1 = slim.fully_connected(aux, num_classes, activation_fn=None,
                                     scope='Logits')
          #aux2 = slim.fully_connected(aux, 3, activation_fn=None,
          #                           scope='Logits_3C')
          end_points['AuxLogits'] = aux1
          #end_points['AuxLogits_3C'] = aux2
      ...
      with tf.variable_scope('Logits'):
        ...
        logits = slim.fully_connected(net, num_classes, activation_fn=None,
                                      scope='Logits')
        #logits_3C = slim.fully_connected(net, 3, activation_fn=None,
        #                              scope='Logits_3C')
        end_points['Logits'] = logits
        #end_points['Logits_3C'] = logits_3C
